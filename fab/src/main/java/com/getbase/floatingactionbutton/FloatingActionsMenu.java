...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private static final float EXPANDED_PLUS_ROTATION_FULL = 180f;
    private static final float EXPANDED_PLUS_ROTATION_HALF = 135f;
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mIsPlusDisplay = attr.getInt(R.styleable.FloatingActionsMenu_fab_menu_type, 0);
        attr.recycle();
    ...
    private static class RotatingDrawable extends LayerDrawable {
        ...
        public RotatingDrawable(Drawable d1, Drawable d2) {
        ...
        mAddButton = new AddFloatingActionButton(context) {
            ...
            Drawable getIconDrawable() {
                if (mIsPlusDisplay == 1) {
                    ...
                    final ObjectAnimator collapseAnimator = ObjectAnimator.ofFloat(rotatingDrawable, "rotation", EXPANDED_PLUS_ROTATION_HALF, COLLAPSED_PLUS_ROTATION);
                    final ObjectAnimator expandAnimator = ObjectAnimator.ofFloat(rotatingDrawable, "rotation", COLLAPSED_PLUS_ROTATION, EXPANDED_PLUS_ROTATION_HALF);
                    ...
                    final ObjectAnimator collapseAnimator = ObjectAnimator.ofFloat(rotatingDrawable, "rotation", EXPANDED_PLUS_ROTATION_FULL, COLLAPSED_PLUS_ROTATION);
                    final ObjectAnimator expandAnimator = ObjectAnimator.ofFloat(rotatingDrawable, "rotation", COLLAPSED_PLUS_ROTATION, EXPANDED_PLUS_ROTATION_FULL);

                    final ObjectAnimator fadeOutAnimator = ObjectAnimator.ofInt(rotatingDrawable, "alpha", 255, 0);
                    final ObjectAnimator fadeInAnimator = ObjectAnimator.ofInt(rotatingDrawable, "alpha", 0, 255);

                    final ObjectAnimator fadeOut = ObjectAnimator.ofInt(drawable, "alpha", 255, 0);
                    final ObjectAnimator fadeIn = ObjectAnimator.ofInt(drawable, "alpha", 0, 255);

                    collapseAnimator.setInterpolator(overshootInterpolator);
                    expandAnimator.setInterpolator(overshootInterpolator);
                    ...
                    mExpandAnimation.playTogether(expandAnimator, fadeOutAnimator, fadeIn);
                    mCollapseAnimation.playTogether(collapseAnimator, fadeInAnimator, fadeOut);

                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                        initIconOpacity(rotatingDrawable, drawable);
                    }
            ...
            /*
             * Allow to avoid a bug when the same button is used several times.
             * (The bug was : the two icons had the value alpha set to 0).
             */
            @TargetApi(19)
                private void initIconOpacity(RotatingDrawable rotatingDrawable, Drawable drawable) {
                    if (rotatingDrawable.getAlpha() == 0) {
                        rotatingDrawable.setAlpha(255);
                        drawable.setAlpha(0);
                    }
                }
        };
    ...
    public void onRestoreInstanceState(Parcelable state) {
        if (state instanceof SavedState) {
            ...
            if (mRotatingDrawable != null) {
                mRotatingDrawable.setRotation(mExpanded ? EXPANDED_PLUS_ROTATION_FULL : COLLAPSED_PLUS_ROTATION);
            }
