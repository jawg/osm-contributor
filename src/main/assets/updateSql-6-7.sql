...
DROP TABLE `POI_TYPE`;
CREATE TABLE `POI_TYPE` (`ID` INTEGER PRIMARY KEY AUTOINCREMENT,  `ICON` VARCHAR, `BACKEND_ID` VARCHAR,`DESCRIPTION` VARCHAR, `NAME` VARCHAR NOT NULL, `USAGE_COUNT` INTEGER, `LAST_USE` BIGINT NOT NULL);
CREATE TABLE `POI_TYPE_TAG` (`ID` INTEGER PRIMARY KEY AUTOINCREMENT, `POI_TYPE_ID` BIGINT NOT NULL, `KEY` VARCHAR NOT NULL, `VALUE` VARCHAR, `ORDINAL` INTEGER NOT NULL, `MANDATORY` SMALLINT NOT NULL);
...
CREATE TABLE `KEYWORD` (`ID` INTEGER PRIMARY KEY AUTOINCREMENT, `POI_TYPE_ID` BIGINT NOT NULL, `VALUE` VARCHAR NOT NULL);