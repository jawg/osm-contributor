...
public class SuggestionsDto {
    ...
    public List<SuggestionsDataDto> getData() {
        return data;
    }

    public void setData(List<SuggestionsDataDto> data) {
        this.data = data;
    }

    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("SuggestionsDto{");
