...
public class CombinationsDto {
    ...
    public List<CombinationsDataDto> getData() {
        return data;
    }

    public void setData(List<CombinationsDataDto> data) {
        this.data = data;
    }

    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("CombinationsDto{");
